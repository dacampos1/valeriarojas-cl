  ...
  collections: [
    {
      ...
      fields: [
        ...
        { label: "Botón de consulta en obras", name: "piece_contact_label", widget: "string", required: false },
    ...
    },
    {
      ...
      files: [
        ...
        {
          id: "works",
          label: "Índice de obras",
          path: "content/pieces/_index.md",
          fields: [
            { label: "Título", name: "title", widget: "string" },
            { label: "Descripción SEO", name: "description", widget: "text" },
            { label: "URL", name: "url", widget: "hidden", default: "/obras/" },
          ],
        },
      ],
    },
